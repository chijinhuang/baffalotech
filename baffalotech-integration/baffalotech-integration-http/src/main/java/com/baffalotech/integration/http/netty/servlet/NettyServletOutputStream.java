...
import com.baffalotech.integration.http.netty.core.NettyHttpCookie;
import com.baffalotech.integration.http.netty.core.NettyHttpResponse;
...
import com.baffalotech.integration.http.netty.core.util.CompositeByteBufX;
...
import com.baffalotech.integration.http.netty.core.util.RecyclableUtil;
 ...
 */
@sun.misc.Contended
public class NettyServletOutputStream extends javax.servlet.ServletOutputStream implements Recyclable  {
    ...
    private static final AbstractRecycler<NettyServletOutputStream> RECYCLER = new AbstractRecycler<NettyServletOutputStream>() {
        @Override
        protected NettyServletOutputStream newInstance() {
            return new NettyServletOutputStream();
        }
    };

    protected NettyServletOutputStream() {}

    public static NettyServletOutputStream newInstance(HttpServletObject httpServletObject) {
        NettyServletOutputStream instance = RECYCLER.getInstance();
    ...
    protected void sendResponse(ChannelFutureListener finishListener){
        ...
        NettyHttpServletRequest servletRequest = httpServletObject.getHttpServletRequest();
        NettyHttpServletResponse servletResponse = httpServletObject.getHttpServletResponse();
        NettyHttpResponse nettyResponse = servletResponse.getNettyResponse();
        NettyServletSessionCookieConfig sessionCookieConfig = httpServletObject.getServletContext().getSessionCookieConfig();
    ...
    private static void settingResponseHeader(boolean isKeepAlive, NettyHttpResponse nettyResponse,
                                       NettyHttpServletRequest servletRequest, NettyHttpServletResponse servletResponse,
                                       NettyServletSessionCookieConfig sessionCookieConfig) {
...
//                !isKeepAlive &&
        ...
        NettyHttpServletSession httpSession = servletRequest.getSession(true);
...
//            httpServletObject = null;
            ...
            RECYCLER.recycleInstance(NettyServletOutputStream.this);
        }
    }
