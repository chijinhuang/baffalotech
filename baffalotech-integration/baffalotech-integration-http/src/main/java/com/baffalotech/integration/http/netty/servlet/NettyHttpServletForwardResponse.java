 ...
 */
@sun.misc.Contended
public class NettyHttpServletForwardResponse extends HttpServletResponseWrapper {
    ...
    public NettyHttpServletForwardResponse(NettyHttpServletResponse response,NettyServletOutputStream outputStream) {
        super(response);
