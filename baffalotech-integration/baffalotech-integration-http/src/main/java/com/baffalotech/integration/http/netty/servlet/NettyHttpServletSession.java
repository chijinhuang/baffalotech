 ...
 */
@sun.misc.Contended
public class NettyHttpServletSession implements HttpSession,Wrapper<Session>{
     ...
     * servlet身份
     */
    private NettyServletPrincipal principal;

    NettyHttpServletSession() {
    }

    NettyHttpServletSession(NettyServletContext servletContext) {
        this.servletContext = servletContext;
    }

    public NettyServletPrincipal getPrincipal() {
        return principal;
    }

    public void setPrincipal(NettyServletPrincipal principal) {
    ...
    public NettyHttpServletSession access(){
