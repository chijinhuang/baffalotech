 ...
 *  2018/7/14/014
 */
public class NettyServletFilterRegistration implements FilterRegistration,FilterRegistration.Dynamic {
    ...
    private NettyServletFilterRegistration self;
    private Set<String> mappingSet;
    private Set<String> servletNameMappingSet;
    private boolean asyncSupported;
    private UrlMapper<NettyServletFilterRegistration> urlMapper;

    public NettyServletFilterRegistration(String filterName, Filter servlet,NettyServletContext servletContext,UrlMapper<NettyServletFilterRegistration> urlMapper) {
    ...
    public void addMappingForUrlPatterns(EnumSet<DispatcherType> dispatcherTypes, boolean isMatchAfter, String... urlPatterns) {
        ...
        for(String pattern : urlPatterns) {
        	if (StringUtils.equals(servletContext.getServletContextName(), "default")
					&& !(filter instanceof NettyProxyFilter)) {
