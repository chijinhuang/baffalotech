...
import com.baffalotech.integration.http.netty.core.util.CookieCodecUtil;
...
//                    InternalAttribute data = (InternalAttribute) interfaceData;
     ...
     * @return
     */
    public static NettyHttpServletResponse unWrapper(ServletResponse response){
