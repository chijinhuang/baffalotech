 ...
 */
@sun.misc.Contended
public class NettyHttpServletAsyncRequest extends HttpServletRequestWrapper{
    ...
    private NettyServletAsyncContext servletAsyncContext;

    public NettyHttpServletAsyncRequest(HttpServletRequest source,NettyServletAsyncContext servletAsyncContext) {
        super(source);
