...
package com.baffalotech.integration.http.netty.servlet.pathmap;

import org.apache.commons.lang3.StringUtils;

import com.baffalotech.integration.http.netty.core.util.URIUtil;
...
public class ServletPathSpec extends PathSpec
{
    ...
    {
        if (StringUtils.isNotBlank(pathSpec) && !pathSpec.startsWith("/") && !pathSpec.startsWith("*")) 
            return "/" + pathSpec;
        return pathSpec;
    }
