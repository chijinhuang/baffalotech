 ...
 * @author 84215
 */
public class NettyServletPrincipal implements Principal,Serializable {

    private final String name;
    private String password;

    public NettyServletPrincipal(String name,String password) {
        if (name == null) {
    ...
    public boolean equals(Object object) {
        ...
        if (object instanceof NettyServletPrincipal) {
            return name.equals(((NettyServletPrincipal)object).getName());
        }
        return false;
    }
